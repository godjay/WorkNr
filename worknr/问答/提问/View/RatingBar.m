...
-(NSInteger)tap:(UITapGestureRecognizer *)gesture{
    if(self.enable){
...
-(NSInteger)pan:(UIPanGestureRecognizer *)gesture{
    if(self.enable){
        CGPoint point = [gesture locationInView:self];
